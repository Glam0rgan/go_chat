...
func (c *imrpcClient) PostMessage(ctx context.Context, in *PostMsg, opts ...grpc.CallOption) (*PostResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedImrpcServer) PostMessage(context.Context, *PostMsg) (*PostResponse, error) {
